...
def ingest(
    ...
    no se filtran filas — eso es trabajo de Silver (Fase 3). Las columnas
    de trazabilidad son la única metadata agregada aquí (ver docstring
    del módulo, `t036`), y son deliberadamente aditivas: no tocan ni
    reinterpretan ninguna columna original del dataset.
    """
